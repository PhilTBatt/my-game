...
export default class DefaultButtonPanel extends Phaser.GameObjects.Container {
    ...
    constructor(scene: BattleScreen) {
        ...
        this.attackButton = new Button(scene, 257, 398, 440, 103, 'Attack', 0xE6E6E6, 0xF80000, '80px',  () => {
        ...
        this.defendButton = new Button(scene, 743, 398, 440, 103, 'Defend', 0xE6E6E6, 0x003EF8, '80px', () => {
            this.setVisible(false)
        ...
        this.itemsButton = new Button(scene, 257, 527, 440, 103, 'Items', 0xE6E6E6, 0x00FF00, '80px', () => {
            this.setVisible(false)
        ...
        this.statsButton = new Button(scene, 743, 527, 450, 105, 'Stats', 0xE6E6E6, 0xFFFF00, '80px', () => {
            this.setVisible(false)
