export default class EnemyIntentBar extends Phaser.GameObjects.Container {
    ...
    constructor(scene: Phaser.Scene, intent: {action: string, value: number}) {
        ...
        this.enemyIntentBar.fillRoundedRect(645.83, 75, 175, 25, 15)
        this.enemyIntentBar.lineStyle(4, 0x000000)
        this.enemyIntentBar.strokeRoundedRect(645.83, 75, 175, 25, 20)

        this.staminaText = scene.add.text(733.33, 88, `${this.intent.action}: ${this.intent.value}`, {fontSize: '24px', color: '#000', fontFamily: 'Arial', align: 'center'})
