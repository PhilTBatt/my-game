...
export default class Player extends Character {
    ...
    skills: [Action?, Action?, Action?] | undefined = [{name: 'Poison', action: 'Poison', value: 5, stamina: 2}, {name: 'Burn', action: 'Fire', value: 5, stamina: 2}, {name: 'Shock', action: 'Electric', value: 5, stamina: 2}]
    coinAmount: number = 0
