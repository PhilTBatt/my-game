...
export default class CoinCount extends Phaser.GameObjects.Container {
    ...
    constructor(scene: FirstBattle) {
        ...
        this.coinIcon = scene.add.image(this.coinCount.width * 0.55 + 45, 70, 'coin-icon').setScale(0.06).setOrigin(0.5)
    ...
    private updateCoinAmount(player: Player, coinAmount: number) {
        ...
        this.coinIcon.setPosition(this.coinCount!.width * 0.55 + 45, 70)
    }
}
