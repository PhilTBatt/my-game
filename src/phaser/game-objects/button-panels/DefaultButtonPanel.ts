...
export default class DefaultButtonPanel extends Phaser.GameObjects.Container {
    ...
    constructor(scene: BattleScreen) {
        ...
        this.attackButton = new Button(scene, 266.67, 400, 400, 105, 'Attack', 0xE6E6E6, 0xF80000, '60px',  () => {
        ...
        this.defendButton = new Button(scene, 733.33, 400, 400, 105, 'Defend', 0xE6E6E6, 0x003EF8, '60px', () => {
            this.setVisible(false)
        ...
        this.itemsButton = new Button(scene, 266.67, 525, 400, 105, 'Items', 0xE6E6E6, 0x00FF00, '60px', () => {
            this.setVisible(false)
        ...
        this.statsButton = new Button(scene, 733.33, 525, 400, 105, 'Stats', 0xE6E6E6, 0xFFFF00, '60px', () => {
            this.setVisible(false)
