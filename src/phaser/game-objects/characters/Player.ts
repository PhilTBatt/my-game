...
export default class Player extends Character {
    ...
    skills: [Action?, Action?, Action?] | undefined = [{name: 'Poison', action: 'Poison', value: 5, stamina: 2}, {name: 'Fire', action: 'Fire', value: 5, stamina: 2}, {name: 'Electric', action: 'Electric', value: 5, stamina: 2}]
    coinAmount: number = 0
